...
public class PhotosListLoader {
    ...
    public ArrayList<FlickiREST.Photo> downloadPhotos() {
        ...
        FlickiREST service = restAdapter.create(FlickiREST.class);
     ...
     */
    private ArrayList<Photo> getRomainsPhotos(FlickiREST service) {
